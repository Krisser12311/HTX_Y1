...
\begin{itemize}
    \item Redegør for, hvordan efterretningstjenester har arbejdet gennem tiden, samt den historiske udvikling af spyware og dens indflydelse på samfundet. Forklar herunder også, hvordan privatlivets fred spiller ind. % Inkluder John lock og hans tanker om privatlivets fred måske også hvordan komunisterne vare tager privatlivets fred
